// Giấy nghỉ phép: Nhóm G - wrapper
const { execSync } = require("child_process");
const fs = require("fs");
const path = require("path");

function parseCliArgs(argv) {
  const args = { input: "data.json", output: "giay_nghi_phep.docx" };
...
if (!data.ten_loai_van_ban) data.ten_loai_van_ban = "GIẤY NGHỈ PHÉP";

const tmpFile = path.join(path.dirname(absInput), "_tmp_gnp.json");
