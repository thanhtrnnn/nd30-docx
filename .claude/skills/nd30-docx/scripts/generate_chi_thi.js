// Chỉ thị: Nhóm A - wrapper
const { execSync } = require("child_process");
const fs = require("fs");
const path = require("path");

function parseCliArgs(argv) {
  const args = { input: "data.json", output: "chi_thi.docx" };
...
if (!data.ten_loai_van_ban) data.ten_loai_van_ban = "CHỈ THỊ";

const tmpFile = path.join(path.dirname(absInput), "_tmp_chi_thi.json");
