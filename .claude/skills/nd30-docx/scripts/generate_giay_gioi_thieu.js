// Giấy giới thiệu: Nhóm E - wrapper
const { execSync } = require("child_process");
const fs = require("fs");
const path = require("path");

function parseCliArgs(argv) {
  const args = { input: "data.json", output: "giay_gioi_thieu.docx" };
...
if (!data.ten_loai_van_ban) data.ten_loai_van_ban = "GIẤY GIỚI THIỆU";

const tmpFile = path.join(path.dirname(absInput), "_tmp_ggt.json");
