// Nghị quyết: Nhóm A - wrapper cho generate_van_ban_co_ten_loai.js
const { execSync } = require("child_process");
const fs = require("fs");
const path = require("path");

function parseCliArgs(argv) {
  const args = { input: "data.json", output: "nghi_quyet.docx" };
...
if (!data.ten_loai_van_ban) data.ten_loai_van_ban = "NGHỊ QUYẾT";
if (data.ket_thuc_dot === undefined) data.ket_thuc_dot = true;

const tmpFile = path.join(path.dirname(absInput), "_tmp_nghi_quyet.json");
